    ...
    group("UI", () {
      testWidgets("Default", (WidgetTester tester) async {
        ...
        await tester.pumpLocalizedWidget(
          const ArcProgressIndicator(value: value),
        );
        ...
        expect(
          find.descendant(of: widget, matching: find.text(l10n.percent(value))),
          findsOneWidget,
        );
      });
      ...
      testWidgets("Hiding the percentage", (WidgetTester tester) async {
        ...
        await tester.pumpLocalizedWidget(
          const ArcProgressIndicator(value: value, showPercentage: false),
        );
        await tester.pumpAndSettle();
      ...
      testWidgets("Custom radius", (WidgetTester tester) async {
        ...
        await tester.pumpLocalizedWidget(
          const ArcProgressIndicator(value: 0.0, radius: customRadius),
        );
        await tester.pumpAndSettle();
    ...
    group("Interactions", () {
      testWidgets(
        ...
        (WidgetTester tester) async {
          ...
          expect(
            find.descendant(of: widget, matching: defaultText),
            findsOneWidget,
          ...
          expect(
            find.descendant(of: widget, matching: find.text(alternativeText)),
            findsOneWidget,
            reason: "The alternative text should be displayed after first tap.",
          );
        },
      );

      testWidgets(
        "Should not switch to alternativeText when it's not provided",
        (WidgetTester tester) async {
          const double value = 0.5;
