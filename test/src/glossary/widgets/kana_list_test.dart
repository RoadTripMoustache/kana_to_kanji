...
void main() {
  group("KanaList", () {
    testWidgets("Empty list",
      ...
      await tester.pumpLocalizedWidget(const KanaList(dataList: [],));
    ...
    testWidgets("Contains 1 kana",
        (WidgetTester tester) async {
      List<Kana> kanaList = [];
      kanaList.add(Kana(1, Alphabets.katakana, 1, "a", "a", "a"));
      await tester.pumpLocalizedWidget(KanaList(dataList: kanaList,));
      await tester.pumpAndSettle();
