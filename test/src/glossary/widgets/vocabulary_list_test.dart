...
void main() {
  group("VocabularyList", () {
    testWidgets("Empty list",
      ...
      await tester.pumpLocalizedWidget(const VocabularyList(dataList: [],));
    ...
    testWidgets("Contains 1 kanji",
      ...
      await tester.pumpLocalizedWidget(VocabularyList(dataList: vocabularyList,));
      await tester.pumpAndSettle();
      ...
      for (var i=0; i<vocabularyList.length; i++) {
        tileList.moveNext();
        expect((tileList.current as VocabularyListTile).data, vocabularyList[i].kanji);
      }
    });
