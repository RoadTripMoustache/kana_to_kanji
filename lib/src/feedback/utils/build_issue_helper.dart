...
String buildIssueTitle(FeedbackType feedbackType) =>
    "${feedbackType == FeedbackType.bug ? "[BUG]" : "[FR]"} from a user";

/// Build the body of a Github issue. The text isn't localized.
/// The text will include the description, email and steps to reproduced based
/// on what is available on [formData].
/// Using the [InfoService], device and application information like
/// application version, device model, device OS will be added.
