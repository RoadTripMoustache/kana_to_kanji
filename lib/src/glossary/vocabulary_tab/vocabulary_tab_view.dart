...
import 'package:kana_to_kanji/src/glossary/vocabulary_tab/vocabulary_tab_view_model.dart';
      ...
      builder: (context, viewModel, __) => AppScaffold(
        ...
        child: Column(
            children: List.generate(
                viewModel.vocabularyList.length,
                (index) =>
                    Card(child: Text(viewModel.vocabularyList[index].kana)))),
      )),
    );
  }
}
