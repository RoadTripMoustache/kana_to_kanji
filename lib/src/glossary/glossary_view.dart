          ...
          return AppScaffold(
            ...
            appBar: AppBar(
              title: GlossarySearchBar(
                ...
                sortGlossary: viewModel.sortGlossary,selectedJlptLevel: viewModel.selectedJlptLevel,
                selectedKnowledgeLevel: viewModel.selectedKnowledgeLevel,selectedOrder: viewModel.selectedOrder,
              ),
              centerTitle: true,
