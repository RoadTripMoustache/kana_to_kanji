            ...
            children: [
              Expanded(
                ...
                child: Padding(
                  ...
                  child: Text(l10n
                      .glossary_filter_by_jlpt_level(JLPTLevel.level1.value)),
                ),
              ),
              Expanded(
                flex: 1,
            ...
            children: [
              Expanded(
                ...
                child: Padding(
                  padding: checkboxPadding,
                  child: Text(l10n
                      .glossary_filter_by_jlpt_level(JLPTLevel.level2.value)),
                ),
              ),
              Expanded(
                flex: 1,
            ...
            children: [
              Expanded(
                ...
                child: Padding(
                  padding: checkboxPadding,
                  child: Text(l10n
                      .glossary_filter_by_jlpt_level(JLPTLevel.level3.value)),
                ),
              ),
              Expanded(
                flex: 1,
            ...
            children: [
              Expanded(
                ...
                child: Padding(
                  padding: checkboxPadding,
                  child: Text(l10n
                      .glossary_filter_by_jlpt_level(JLPTLevel.level4.value)),
                ),
              ),
              Expanded(
                flex: 1,
            ...
            children: [
              Expanded(
                ...
                child: Padding(
                  padding: checkboxPadding,
                  child: Text(l10n
                      .glossary_filter_by_jlpt_level(JLPTLevel.level5.value)),
                ),
              ),
              Expanded(
                flex: 1,
