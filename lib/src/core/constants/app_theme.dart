...
class AppTheme {
  ...
  static ThemeData darkTheme = RTMTheme.dark(
    ...
    RTMBottomNavigationBarThemeData(backgroundColor: dark.surface),
    navigationBarTheme:
    RTMNavigationBarThemeData(backgroundColor: dark.surface),
    navigationRailTheme:
    RTMNavigationRailThemeData(backgroundColor: dark.surface),
    progressIndicatorTheme: RTMProgressIndicatorThemeData(
      color: primary[600],
      circularBackgroundColor: primary[200],
      circularTextColor: primary[700],
